...
if __name__ == "__main__":
    filename = "/home/bee/emotion-recognition-using-speech/Audio_Speech_Actors_01-24/Actor_01/03-01-08-02-02-02-01.wav"
    
    #filename = '/home/bee/TFM-MAL/pepper_expression/emotions_data.csv'
    #dataframe = pd.read_csv(filename)
    #index = 0
    result,valence, arousal = predict_emotion(filename)
    print(result)
    print(valence)
    print(arousal)
