...
def predict_emotion(dataframe,index):
    ...
    parser.add_argument("-e", "--emotions", help=
                                            ...
                                            """, default="sad,neutral,disgust,happy,angry,ps,fear,calm")
    ...
    return result,val,aro

if __name__ == "__main__":
    #filename = "/home/bee/TFM-MAL/pepper_expression/code/emotions_data/Audio_Speech_Actors_01-24/Actor_01/03-01-08-02-01-01-01.wav"
    
    filename = '/home/bee/TFM-MAL/pepper_expression/emotions_data.csv'
    dataframe = pd.read_csv(filename)
    index = 47
    result,valence, arousal = predict_emotion(dataframe, index)
    print(result)
    print(valence)
    print(arousal)
